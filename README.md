...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,react,nodejs,python,cpp,java,spring,angular,rabbitmq,jenkins,azure,bash,npm,redis,postgres,mongodb,mysql,firebase,aws,docker,git,vscode&perline=6)](https://skillicons.dev)
